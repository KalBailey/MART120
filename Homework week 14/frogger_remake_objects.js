...
var Daisy;
var Dahlia;
rosex = getRandomNumber(600);
daisyx = getRandomNumber(600);
dahliax = getRandomNumber(600);
...
function setup()
{
  ...
  //create flowers
    Rose = new Flower(rosex,312,22,200,35,50);
    Daisy = new Flower(daisyx,576,22,250,220,80);
    Dahlia = new Flower(dahliax,576,22,250,100,100);
